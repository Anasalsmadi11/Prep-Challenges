...
const filterLinks = (str) => {
    // write your code here
    let hrefStart = str.indexOf("//")
    let linkStart = hrefStart +2;
    let linkEnd = str.indexOf('"',linkStart)
    let link = str.slice(linkStart, linkEnd)
    return link
}
// -------------------------------------------------------------------------------------------------------
...
const isPalindrome = (str) => {
    ...
    console.log(str)
    return str === str.split('').reverse().join('') // if equal return true
}
// -------------------------------------------------------------------------------------------------------
